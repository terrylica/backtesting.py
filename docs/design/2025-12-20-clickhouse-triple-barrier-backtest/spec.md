...
- [x] **Task 1.1**: Create `get_data_from_clickhouse()` adapter function
...
- [x] **Task 1.2**: Create ClickHouse connection configuration
...
- [x] **Task 2.1**: Create SQL templates for microstructure aggregation
...
- [x] **Task 2.2**: Create Python wrapper for SQL execution
...
- [x] **Task 3.1**: Implement `compute_triple_barrier_labels()` function
...
- [x] **Task 3.2**: Create hyperparameter grid for b and H
...
- [x] **Task 4.1**: Implement `purged_kfold_split()` generator
...
- [x] **Task 4.2**: Implement `TripleBarrierClassifier` class
...
- [x] **Task 4.3**: Implement hyperparameter optimization
...
- [x] **Task 5.1**: Implement `TripleBarrierProbStrategy` class
...
- [x] **Task 5.2**: Create end-to-end pipeline script
...
- [x] **Task 5.3**: Add calibration diagnostics
...
- [x] **Task 6.1**: Create comprehensive docstrings
  - Mathematical formulations in docstrings
  - Example usage patterns
  - Parameter descriptions

- [x] **Task 6.2**: Create pytest test suite
...
- [x] ClickHouse connection works with gapless-crypto-clickhouse
- [x] Microstructure features computed from 1-second data
- [x] Triple-barrier labels generated correctly
- [x] Classifier produces calibrated probabilities (reliability diagram)
- [x] Purged CV prevents look-ahead bias
- [x] backtesting.py strategy runs without errors
- [x] Threshold optimization produces meaningful results
